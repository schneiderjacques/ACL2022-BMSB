...
public class EndScreen {
        ...
        public EndScreen(DrawingPanel dp) {
            ...
            try {
                backgroundImage = ImageIO.read(MenuScreen.class.getResource("/main/resources/images/menu/background.jpg"));
            } catch (IOException e) {
                e.printStackTrace();
            }
            try {
                GraphicsEnvironment ge = GraphicsEnvironment.getLocalGraphicsEnvironment();
                ge.registerFont(Font.createFont(Font.TRUETYPE_FONT, MenuScreen.class.getResource("/main/resources/font/Minecraft.ttf").openStream()));
