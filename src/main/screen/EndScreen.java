...
public class EndScreen {
        ...
        public EndScreen(DrawingPanel dp) {
            ...
            try {
                backgroundImage = ImageIO.read(main.screen.MenuScreen.class.getResource("/resources/images/menu/background.jpg"));
            } catch (IOException e) {
                e.printStackTrace();
            }
            try {
                GraphicsEnvironment ge = GraphicsEnvironment.getLocalGraphicsEnvironment();
                ge.registerFont(Font.createFont(Font.TRUETYPE_FONT, main.screen.MenuScreen.class.getResource("/resources/font/Minecraft.ttf").openStream()));
